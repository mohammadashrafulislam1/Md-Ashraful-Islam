...
const ProjectSection = () => {
  ...
  // useKeenSlider hook moved inside the component
          ...
          <div key={index}>
            ...
            <div className="keen-slider" ref={sliderRef}>
             {project.galleryImages.map((image, imageIndex) => (
                <div className="keen-slider__slide" key={imageIndex}>
                  <figure>
                    <img className="gallery-img" src={image} alt={`Gallery Image ${imageIndex}`} />
                  </figure>
                </div>
              ))}
             </div>
