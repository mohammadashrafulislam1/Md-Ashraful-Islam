...
const MyWork = () => {
    return (
    <div className="bg-gradient-to-r from-[#212121] to-[#111111] rounded-3xl md:py-10 md:px-16 p-10 flex md:gap-5 gap-2 mb-5 md:mb-0">
       
       <div className="bg-gradient-to-r from-[#242424] to-[#1b1b1b] rounded-3xl w-[180px] h-[180px] text-center flex flex-col justify-center items-center">
